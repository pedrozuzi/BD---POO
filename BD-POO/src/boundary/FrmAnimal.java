...
//		panPrincipalAnimal.add(textField_1);
...
//		});
	...
	public FrmAnimal(JDialog jd) {
		...
		scrollPaneBusca.getViewport().add(tableBusca);
		scrollPaneBusca.setBounds(10, 107, 549, 159);
...
//		tableAnimal.addMouseListener(this);
//		tableAnimal.getTableHeader().setReorderingAllowed(false); //deixar as colunas para nao serem movidas de seu lugar original
//		tableAnimal.getColumnModel().getColumn(0).setResizable(false);
//		tableAnimal.getColumnModel().getColumn(0).setPreferredWidth(200);
//		tableAnimal.getColumnModel().getColumn(1).setPreferredWidth(100);
//		scrollPane.setViewportView(tableAnimal);
//		return modelo;
//}
